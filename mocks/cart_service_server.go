...
// CartServiceServer is an autogenerated mock type for the CartServiceServer type
type CartServiceServer struct {
	mock.Mock
}

// AddToCart provides a mock function with given fields: _a0, _a1
func (_m *CartServiceServer) AddToCart(_a0 context.Context, _a1 *proto.NewCartItem) (*proto.CartItem, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *proto.CartItem
	if rf, ok := ret.Get(0).(func(context.Context, *proto.NewCartItem) *proto.CartItem); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *proto.NewCartItem) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
// RemoveItemsFromCart provides a mock function with given fields: _a0, _a1
func (_m *CartServiceServer) RemoveItemsFromCart(_a0 context.Context, _a1 *proto.RemoveItemsFromCartInput) (*proto.RemoveItemsFromCartResponse, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *proto.RemoveItemsFromCartResponse
	if rf, ok := ret.Get(0).(func(context.Context, *proto.RemoveItemsFromCartInput) *proto.RemoveItemsFromCartResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *proto.RemoveItemsFromCartInput) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
